...
DATASET_FLAGS="
 --data_dir /mnt/lustre/yslan/logs/nips23/Reconstruction/lmdb_debug/${dataset_name}_full/ \
"
...
TRAIN_FLAGS="--iterations 10001 --anneal_lr False \
 ...
 --cls_token False \
 --weight_decay 0.05 \
 --resume_checkpoint /mnt/lustre/yslan/logs/nips23/Reconstruction/final/chair/vae/get3d/RodinSR_256_fusionv5_ConvQuant/upper_new/mv/vitb-kl1.0e-06-64+64-rec_patch_newarch_oldSRModel-128-full/model_rec0950000.pt \
 --no_dim_up_mlp True \
