...
# data_dir=/mnt/cache/yslan/get3d/lmdb_debug/chair/ # ! lmdb 
data_dir=/mnt/lustre/yslan/logs/nips23/Reconstruction/lmdb_debug/chair_full/
...
TRAIN_FLAGS="--iterations 10001 --anneal_lr False \
 ...
 --symmetry_loss False \
 --vae_p 2 \
 --resume_checkpoint /mnt/lustre/yslan/logs/nips23/Reconstruction/final/chair/vae/get3d/RodinSR_256_fusionv5_ConvQuant/upper_new/mv/vitb-kl1.0e-06-64+64-rec_patch_newarch_oldSRModel-128-ctd-compileConv/model_rec0560000.pt \
 "
...
logdir=/mnt/lustre/yslan/logs/nips23/Reconstruction/final/chair/vae/get3d/RodinSR_256_fusionv5_ConvQuant/upper_new/mv/vitb-kl${kl_lambda}-64+64-rec_patch_newarch_oldSRModel-${image_size}-full
