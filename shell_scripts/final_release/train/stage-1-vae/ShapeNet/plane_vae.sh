...
batch_size=8 # 30.704 GiB on patch=32; 
...
data_dir=/mnt/cache/yslan/get3d/lmdb_debug/plane/ # ! lmdb 

eval_data_dir=/mnt/lustre/yslan/3D_Dataset/get3d/plane_test
...
TRAIN_FLAGS="--iterations 10001 --anneal_lr False \
 ...
 --symmetry_loss False \
 --vae_p 2 \
 --resume_checkpoint /mnt/lustre/yslan/logs/nips23/Reconstruction/final/plane/vae/get3d/RodinSR_256_fusionv5_ConvQuant/upper_new/mv/vitb-kl1.0e-06-64+64-rec_patch_newarch_oldSRModel-128-ctd/model_rec0430000.pt
 "
...
logdir=/mnt/lustre/yslan/logs/nips23/Reconstruction/final/plane/vae/get3d/RodinSR_256_fusionv5_ConvQuant/upper_new/mv/vitb-kl${kl_lambda}-64+64-rec_patch_newarch_oldSRModel-${image_size}-ctd2-nocompile
